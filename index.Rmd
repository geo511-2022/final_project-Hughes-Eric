...
```{r, message=F, warning=F, fig.cap="Plot showing median household income by census tract and where supermarkets are located"}
...
```{r, message=F, warning=F, fig.cap="Plot showing vehicle access proportions by census tract and where supermarkets are located"}
...
```{r, message=F, warning=F,fig.cap="Summary table for median household income data and proximity to the nearest supermarket"}
...
income_table
```
```{r, message=F, warning=F,fig.cap="Summary table for vehicle access data and proximity to the nearest supermarket"}
